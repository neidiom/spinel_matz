...
static const char*sp_str_concat(const char*a,const char*b){if(!a)a="";if(!b)b="";size_t la=strlen(a),lb=strlen(b);char*r=sp_str_alloc(la+lb);memcpy(r,a,la);memcpy(r+la,b,lb);return r;}
